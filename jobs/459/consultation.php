...
$name=$_POST['name'];
$phone=$_POST['phone'];
 // mail("info@ceh499.ru", "Заказ консультации с сайта ".$_SERVER['HTTP_REFERER']," Имя: ".$name."\nНомер телефона: ".$phone); // письмо на свой электронный ящик, измените на свой email
 mail("info@ceh495.ru", "Заказ консультации с сайта ".$_SERVER['HTTP_REFERER']," Имя: ".$name."\nНомер телефона: ".$phone); // письмо на свой электронный ящик, измените на свой email
 // mail("Sss53@yandex.ru", "Заказ консультации с сайта ".$_SERVER['HTTP_REFERER']," Имя: ".$name."\nНомер телефона: ".$phone); // письмо на свой электронный ящик, измените на свой email
